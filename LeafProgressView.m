...
- (void)setProgress:(CGFloat)rate{
    self.progressImageView.frame = CGRectMake(_progressImageView.frame.origin.x, _progressImageView.frame.origin.y, (_progressBGImageView.frame.size.width-15) * rate, _progressImageView.frame.size.height);
