...
- (void)setFirstStateIconName:(NSString *)firstIconName
          ...
          secondStateIconName:(NSString *)secondIconName
               ...
               fourthIconName:(NSString *)fourthIconName
                  fourthColor:(UIColor *)fourthColor {
   !firstIconName?: [self setFirstIconName:firstIconName];
    !secondIconName?:  [self setSecondIconName:secondIconName];
    !thirdIconName?: [self setThirdIconName:thirdIconName];
    !fourthIconName?: [self setFourthIconName:fourthIconName];

    !firstColor?:  [self setFirstColor:firstColor];
    !secondColor?:[self setSecondColor:secondColor];
    !thirdColor?: [self setThirdColor:thirdColor];
    !fourthColor?: [self setFourthColor:fourthColor];
}
