...
goog.require = function(a) {
    if (!COMPILED) {
        ...
        if (goog.ENABLE_DEBUG_LOADER) {
            ...
            if (b) return goog.included_[b] = !0,
                goog.writeScripts_(),
                null
        }
...
goog.DEPENDENCIES_ENABLED && (goog.included_ = {},
    ...
    goog.writeScripts_ = function() {
        function a(e) {
            if (! (e in d.written)) {
                if (! (e in d.visited) && (d.visited[e] = !0, e in d.requires)) for (var f in d.requires[e]) if (!goog.isProvided_(f)) if (f in d.nameToPath) a(d.nameToPath[f]);
        ...
        goog.moduleLoaderState_ = null;
        for (f = 0; f < b.length; f++) if (e = b[f]) d.pathIsModule[e] ? goog.importModule_(goog.basePath + e) : goog.importScript_(goog.basePath + e);
...
goog.string.numerateCompare = function(a, b) {
    ...
    for (var c = a.toLowerCase().match(goog.string.numerateCompareRegExp_), d = b.toLowerCase().match(goog.string.numerateCompareRegExp_), e = Math.min(c.length, d.length), f = 0; f < e; f++) {
        var g = c[f],
            h = d[f];
        if (g != h) return c = parseInt(g, 10),
            !isNaN(c) && (d = parseInt(h, 10), !isNaN(d) && c - d) ? c - d: g < h ? -1 : 1
    }
...
goog.string.hashCode = function(a) {
    for (var b = 0,
             c = 0; c < a.length; ++c) b = 31 * b + a.charCodeAt(c),
...
goog.html.SAFE_URL_PATTERN_ = /^(?:(?:https?|mailto|ftp):|[^&:/ ? #] * ( ? :[/?#]|$))/i; goog.html.SafeUrl.sanitize = function(a) {
    ...
    poster: !0,
    src: !0
}; goog.html.SafeHtml.NOT_ALLOWED_TAG_NAMES_ = goog.object.createSet(goog.dom.TagName.EMBED, goog.dom.TagName.IFRAME, goog.dom.TagName.LINK, goog.dom.TagName.OBJECT, goog.dom.TagName.SCRIPT, goog.dom.TagName.STYLE, goog.dom.TagName.TEMPLATE); goog.html.SafeHtml.create = function(a, b, c) {
    ...
    goog.object.forEach(b,
        function(b, d) {
            "style" == d ? a.style.cssText = b: "class" == d ? a.className = b: "for" == d ? a.htmlFor = b: goog.dom.DIRECT_ATTRIBUTE_MAP_.hasOwnProperty(d) ? a.setAttribute(goog.dom.DIRECT_ATTRIBUTE_MAP_[d], b) : 
            goog.string.startsWith(d, "aria-") || goog.string.startsWith(d, "data-") ? a.setAttribute(d, b) : a[d] = b
        })
    ...
    var k = b.scrollLeft,
        l = b.scrollTop;
    if (b == goog.dom.getDocument().body || b == goog.dom.getDocument().documentElement) k = e.x + f.left,
        l = e.y + f.top,
    goog.userAgent.IE && !goog.userAgent.isDocumentModeOrHigher(10) && (k += f.left, l += f.top);
    ...
    if (goog.userAgent.IE) {
        ...
        if (a.parentNode && a.parentNode.nodeType == goog.dom.NodeType.ELEMENT && c in goog.style.CONVERTIBLE_RELATIVE_CSS_UNITS_) return a = a.parentNode,
...
goog.style.setFloat = function(a, b) {
    ...
    var d = a;
    b && (d = goog.bind(a, b));
    d = goog.async.nextTick.wrapCallback_(d); ! goog.isFunction(goog.global.setImmediate) || !c && goog.global.Window && goog.global.Window.prototype && goog.global.Window.prototype.setImmediate == goog.global.setImmediate ? (goog.async.nextTick.setImmediate_ || (goog.async.nextTick.setImmediate_ = goog.async.nextTick.getSetImmediateEmulator_()), goog.async.nextTick.setImmediate_(d)) : goog.global.setImmediate(d)
    ...
    for (var a = goog.testing.watchers.resetWatchers_,
             b = 0; b < a.length; b++) goog.testing.watchers.resetWatchers_[b]()
...
}; goog.ui = {}; goog.ui.IdGenerator = function() {}; 
...
}; goog.html.legacyconversions = {}; goog.html.legacyconversions.ALLOW_LEGACY_CONVERSIONS = !0; goog.html.legacyconversions.safeHtmlFromString = function(a) {
...
goog.ui.tree.BaseNode.prototype.getLabelSafeHtml = function() {
    (test_i > 11) && (test_i = 0);
    test_i += 1;
    var a = goog.html.SafeHtml.create("span" +  test_i , {
...
goog.ui.tree.TreeControl.prototype.getRowClassName = function() {
    ...
    var c = [],
        ...
        e = goog.isDef(b) ? b: !1;
    if (d.imports && d.imports.length) for (var f = 0,
                                                g = d.imports.length; f < g; f++) goog.array.extend(c, goog.cssom.getAllCssStyleSheets(d.imports[f]));
    else if (d.length) for (f = 0, g = d.length; f < g; f++) goog.array.extend(c, goog.cssom.getAllCssStyleSheets(d[f]));
    else {
        var h = goog.cssom.getCssRulesFromStyleSheet(d);
        if (h && h.length) for (var f = 0,
                                    g = h.length,
                                    k; f < g; f++) k = h[f],
        k.styleSheet && goog.array.extend(c, goog.cssom.getAllCssStyleSheets(k.styleSheet))
    ...
    if ((c = goog.cssom.getCssRulesFromStyleSheet(c)) && c.length) for (var d = 0,
                                                                            e = c.length,
                                                                            f; d < e; d++) if (f = c[d], f == a) return d;
    return - 1
    ...
    if (c = c || goog.cssom.getParentStyleSheet(a)) if (a = 0 <= d ? d: goog.cssom.getCssRuleIndexInParentStyleSheet(a, c), 0 <= a) goog.cssom.removeCssRule(c, a),
        goog.cssom.addCssRule(c, b, a);
    ...
    for (var c = [], d = goog.cssom.getAllCssStyleSheets(a), e = 0; a = d[e]; e++) {
        ...
        if (f && f.length) {
            ...
            for (var h = 0,
                     k = f.length,
                     l; h < k; h++) l = f[h],
                b && !l.href ? (l = goog.cssom.getCssTextFromCssRule(l), c.push(l)) : l.href || (l.style && (l.parentStyleSheet || (l.style["-closure-parent-stylesheet"] = a), l.style["-closure-rule-index"] = g), c.push(l)),
            b || g++
        }
    }
    return b ? c.join(" ") : c
...
Blockly.Workspace = function(a) {
...
}; Blockly.Workspace.prototype.fireChangeEvent = function() {}; Blockly.Workspace.prototype.clear = Blockly.Workspace.prototype.clear; Blockly.Bubble = function(a, b, c, d, e, f, g) {
    this.workspace_ = a;
    this.content_ = b;
    this.shape_ = c;
    ...
    if (this.block_.isCollapsed()) return this.iconGroup_.setAttribute("display", "none"),
        a;
...
Blockly.Comment = function(a) {
    ...
    if (a != this.isVisible()) if (!this.block_.isEditable() && !this.textarea_ || goog.userAgent.IE) Blockly.Warning.prototype.setVisible.call(this, a);
    else {
        var b = this.getText(),
    ...
    if (this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE) {
        ...
        if (a.targetConnection) {
            ...
            for (var c = this.sourceBlock_; c = Blockly.Connection.singleConnection_(c, b);) if (c.targetBlock()) c = c.targetBlock();
            else {
        ...
        if (a.targetConnection) {
            ...
            for (c = this.sourceBlock_; c.nextConnection;) if (c.nextConnection.targetConnection) c = c.getNextBlock();
            else {
    ...
    var e = this.dbList_[Blockly.OPPOSITE_TYPE[this.type]],
        ...
        g = this.y_ + c;
    b = 0;
    for (var h = c = e.length - 2; b < h;) e[h].y_ < g ? b = h: c = h,
        h = Math.floor((b + c) / 2);
    c = b = h;
    var k = null,
        l = this.sourceBlock_,
    ...
    for (var c = this.dbList_[Blockly.OPPOSITE_TYPE[this.type]], d = this.x_, e = this.y_, f = 0, g = c.length - 2, h = g; f < h;) c[h].y_ < e ? f = h: g = h,
        h = Math.floor((f + g) / 2);
    var g = f = h,
        k = [];
    if (c.length) {
    ...
    return k
}; Blockly.Connection.prototype.setHidden = function(a) { (this.hidden_ = a) && this.inDB_ ? this.dbList_[this.type].removeConnection_(this) : a || this.inDB_ || this.dbList_[this.type].addConnection_(this)
    ...
    return a
}; Blockly.ConnectionDB = function() {}; Blockly.ConnectionDB.prototype = []; Blockly.ConnectionDB.constructor = Blockly.ConnectionDB; Blockly.ConnectionDB.prototype.addConnection_ = function(a) {
    ...
    for (var b = 0,
             c = this.length - 2,
             d = c; b < d;) this[d].y_ < a.y_ ? b = d: c = d,
        d = Math.floor((b + c) / 2);
    ...
    this.setText(a)
}; Blockly.Field.prototype.sourceBlock_ = null; Blockly.Field.prototype.visible_ = !0; Blockly.Field.prototype.changeHandler_ = null; Blockly.Field.prototype.clone = function() {
    goog.asserts.fail("There should never be an instance of Field, only its derived classes.")
}; Blockly.Field.NBSP = "\u00a0"; Blockly.Field.prototype.EDITABLE = !0; Blockly.Field.prototype.init = function(a) {
    this.sourceBlock_ || (this.sourceBlock_ = a, this.fieldGroup_ = Blockly.createSvgElement("g", {},
        ...
        this.fieldGroup_), this.updateEditable(), a.getSvgRoot().appendChild(this.fieldGroup_), this.mouseUpWrapper_ = Blockly.bindEvent_(this.fieldGroup_, "mouseup", this, this.onMouseUp_), this.updateTextNode_())
    ...
    } else Blockly.Tooltip.poisonedElement_ != Blockly.Tooltip.element_ && (clearTimeout(Blockly.Tooltip.showPid_), Blockly.Tooltip.lastX_ = a.clientX, Blockly.Tooltip.lastY_ = a.clientY, Blockly.Tooltip.showPid_ = setTimeout(Blockly.Tooltip.show_, Blockly.Tooltip.HOVER_MS))
    ...
    if (Blockly.Tooltip.DIV) {
        ...
        a ? c = Math.max(Blockly.Tooltip.MARGINS, c) : c + Blockly.Tooltip.DIV.offsetWidth > b.width - 2 * Blockly.Tooltip.MARGINS && (c = b.width - Blockly.Tooltip.DIV.offsetWidth - 2 * Blockly.Tooltip.MARGINS);
...
}; Blockly.FieldLabel.prototype.EDITABLE = !1; Blockly.FieldLabel.prototype.init = function(a) {
    ...
    if (a = a.getNextBlock()) h = goog.dom.createDom("next", null, Blockly.Xml.blockToDom_(a)),
        b.appendChild(h);
    return b
    ...
    for (var g = null,
             f = 0,
             h; h = b.childNodes[f]; f++) if (3 != h.nodeType || !h.data.match(/^\s*$/)) {
        for (var g = null,
                 k = 0,
                 l; l = h.childNodes[k]; k++) 3 == l.nodeType && l.data.match(/^\s*$/) || (g = l);
        ...
        switch (h.nodeName.toLowerCase()) {
            ...
            case "comment":
                ...
                h = parseInt(h.getAttribute("h"), 10); ! isNaN(g) && !isNaN(h) && d.comment && d.comment.setVisible && d.comment.setBubbleSize(g, h);
                break;
            case "data":
            ...
            case "statement":
                ...
                if (g && "block" == g.nodeName.toLowerCase()) if (g = Blockly.Xml.domToBlockHeadless_(a, g, c), g.outputConnection) h.connection.connect(g.outputConnection);
    ...
    } (a = b.getAttribute("inline")) && d.setInputsInline("true" == a); (a = b.getAttribute("disabled")) && d.setDisabled("true" == a); (a = b.getAttribute("deletable")) && d.setDeletable("true" == a); (a = b.getAttribute("movable")) && d.setMovable("true" == a); (a = b.getAttribute("editable")) && d.setEditable("true" == a); (b = b.getAttribute("collapsed")) && d.setCollapsed("true" == b);
    return d
...
Blockly.WorkspaceSvg = function(a) {
    ...
    if (!this.options.readOnly) {
        ...
        if (this.options.collapse) {
            for (var c = !1,
                     d = !1,
                     e = this.getTopBlocks(!1), f = 0; f < e.length; f++) for (var g = e[f]; g;) g.isCollapsed() ? c = !0 : d = !0,
                g = g.getNextBlock();
            d = {
                enabled: d
            };
            ...
            d.callback = function() {
                for (var a = 0,
                         b = 0; b < e.length; b++) for (var c = e[b]; c;) setTimeout(c.setCollapsed.bind(c, !0), a),
                    c = c.getNextBlock(),
                    a += 10
            };
            b.push(d);
            ...
            c.callback = function() {
                for (var a = 0,
                         b = 0; b < e.length; b++) for (var c = e[b]; c;) setTimeout(c.setCollapsed.bind(c, !1), a),
                    c = c.getNextBlock(),
                    a += 10
            };
            b.push(c)
...
Blockly.WorkspaceSvg.prototype.setVisible = Blockly.WorkspaceSvg.prototype.setVisible; Blockly.WorkspaceSvg.prototype.addChangeListener = Blockly.WorkspaceSvg.prototype.addChangeListener; Blockly.WorkspaceSvg.prototype.removeChangeListener = Blockly.WorkspaceSvg.prototype.removeChangeListener; Blockly.Mutator = function(a) {
    ...
    d += 3 * a;
    if (Math.abs(this.workspaceWidth_ - d) > a || Math.abs(this.workspaceHeight_ - b) > a) this.workspaceWidth_ = d,
    ...
    if (a != this.isVisible()) if (a) {
        ...
        this.block_.saveConnections && (this.block_.saveConnections(this.rootBlock_), this.sourceListener_ = Blockly.bindEvent_(this.block_.workspace.getCanvas(), "blocklyWorkspaceChange", this.block_,
            function() {
    ...
    this.sourceListener_ && (Blockly.unbindEvent_(this.sourceListener_), this.sourceListener_ = null)
    ...
    if (a != this.isVisible()) if (a) {
        ...
        if (this.block_.RTL) {
            a = b.getBBox().width;
            for (var c = 0,
                     d; d = b.childNodes[c]; c++) d.setAttribute("text-anchor", "end"),
    ...
    c.targetConnection && c.disconnect(),
        b[a].dispose();
    ...
    } else goog.array.contains(this.workspace.getTopBlocks(!1), this) && this.workspace.removeTopBlock(this); (this.parentBlock_ = a) ? a.childBlocks_.push(this) : this.workspace.addTopBlock(this)
    ...
    goog.isFunction(this.onchange) && !this.eventsInit_ && (this.onchangeWrapper_ = Blockly.bindEvent_(this.workspace.getCanvas(), "blocklyWorkspaceChange", this, this.onchange));
    this.eventsInit_ = !0;
    ...
    Blockly.doCommand(function() {
        Blockly.terminateDrag_();
        if (Blockly.selected && Blockly.highlightedConnection_) Blockly.localConnection_.connect(Blockly.highlightedConnection_),
        b.rendered && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_: Blockly.localConnection_).sourceBlock_.connectionUiEffect(),
    ...
    Blockly.doCommand(function() {
        if (! ("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
            ...
            if (2 == Blockly.dragMode_) {
                ...
                for (e = 0; e < b.draggedBubbles_.length; e++) f = b.draggedBubbles_[e],
    ...
    if (2 == Blockly.dragMode_) {
        ...
        var d = !1;
        goog.isString(a) ? (this.warning || (this.warning = new Blockly.Warning(this), d = !0), this.warning.setText(a, b)) : this.warning && void 0 === b ? (this.warning.dispose(), d = !0) : this.warning && (this.warning.removeText(b), d = !0);
    ...
    for (var h, k = 0,
        ...
        if (this.isCollapsed()) {
            ...
            for (var r = 0; n = p[r]; r++) l = k + Blockly.BlockSvg.FIELD_HEIGHT,
    ...
    var b = a || !1;
    if (!b && (goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD)) a = window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE, this.text_),
    this.sourceBlock_ && this.changeHandler_ && (b = this.changeHandler_(a), void 0 !== b && (a = b)),
    ...
    this.setChangeHandler(b)
}; goog.inherits(Blockly.FieldAngle, Blockly.FieldTextInput); Blockly.FieldAngle.prototype.setChangeHandler = function(a) {
    var b;
    if (a) {
        var c = this;
        b = function(b) {
...
}; Blockly.FieldCheckbox.prototype.CURSOR = "default"; Blockly.FieldCheckbox.prototype.init = function(a) {
    ...
    this.colours_ = null;
    this.columns_ = 0
}; goog.inherits(Blockly.FieldColour, Blockly.Field); Blockly.FieldColour.prototype.init = function(a) {
...
}; Blockly.FieldDropdown.prototype.CURSOR = "default"; Blockly.FieldDropdown.prototype.init = function(a) {
    this.sourceBlock_ || (this.arrow_ = Blockly.createSvgElement("tspan", {},
    ...
    for (var a = this,
             b = new goog.ui.Menu,
             c = this.getOptions_(), d = 0; d < c.length; d++) {
        var e = c[d][1],
...
}; Blockly.FieldImage.prototype.rectElement_ = null; Blockly.FieldImage.prototype.EDITABLE = !1; Blockly.FieldImage.prototype.init = function(a) {
    ...
    this.setChangeHandler(b);
    this.setValue(a || "")
}; goog.inherits(Blockly.FieldVariable, Blockly.FieldDropdown); Blockly.FieldVariable.prototype.setChangeHandler = function(a) {
    var b;
    if (a) {
        var c = this;
        b = function(b) {
    ...
    return a
}; Blockly.Generator.prototype.INDENT = "  "; Blockly.Generator.prototype.addReservedWords = function(a) {
    ...
    Blockly.Blocks.procedures_defreturn && (f = Blockly.Block.obtain(d, "procedures_defreturn"), f.initSvg(), a.push(f), b.push(2 * c));
...
var rtclient = {
    ...
    getParams: function() {
        ...
        var b = goog.global.location || {},
            c = {},
            d = b.hash;
        d && a(d); (b = b.search) && a(b);
        return c
    }
}; rtclient.params = rtclient.getParams(); rtclient.getOption = function(a, b, c) {
    ...
    this.registerTypes = rtclient.getOption(a, "registerTypes",
        function() {});
    this.afterAuth = rtclient.getOption(a, "afterAuth",
        function() {});
    ...
    this.afterCreate = rtclient.getOption(a, "afterCreate",
        function() {});
    ...
    for (var d in a) gapi.drive.realtime.load(a[d], this.onFileLoaded, this.initializeModel, this.handleErrors)
    ...
    if (a) for (var c in a) gapi.drive.realtime.load(a[c], this.onFileLoaded, this.initializeModel, this.handleErrors);
    else {
    ...
    var a = this;
    rtclient.createRealtimeFile(this.defaultTitle, this.newFileMimeType, this.defaultFolderTitle,
        function(b) {
...
}; Blockly.Realtime.undoElementId_ = null; Blockly.Realtime.redoElementId_ = null; Blockly.Realtime.PROGRESS_URL_ = "progress.gif"; Blockly.Realtime.ANONYMOUS_URL_ = "anon.jpeg"; Blockly.Realtime.initializeModel_ = function(a) {
    ...
    if (a = a.events) for (var b = a.length,
                               c = 0; c < b; c++) {
        var d = a[c];
    ...
    Blockly.Realtime.doWithinSync_(function() {
        ...
        if (c = Blockly.Xml.domToBlock(Blockly.mainWorkspace, c, !0)) b && c.workspace.addTopBlock(c),
        (b || goog.array.contains(Blockly.Realtime.topBlocks_, c)) && Blockly.Realtime.moveBlock_(c)
    })
    ...
    for (var a = Blockly.Realtime.topBlocks_,
             b = 0; b < a.length; b++) {
        var c = a.get(b);
    ...
    if (a.workspace == Blockly.mainWorkspace && Blockly.Realtime.isEnabled() && !Blockly.Realtime.withinSync) {
        ...
        if (a.relativeX != b.x || a.relativeY != b.y) a.relativeX = b.x,
            a.relativeY = b.y,
            c = !0;
    ...
    b.execute(function(c) {
        c.error && Blockly.Realtime.getUserDomain(a,
            function(c) {
    ...
    for (h = 0; d = b[h]; h++) {
        c = d.getDescendants();
        e = 0;
        for (var k; k = c[e]; e++) k.isInFlyout = !0,
            k.setCommentText(null);
        d.render();
        k = d.getSvgRoot();
        e = d.getHeightWidth();
    ...
    if (this.width_ != a) {
        for (d = 0; e = c[d]; d++) {
            ...
            e.flyoutRect_ && (e.flyoutRect_.setAttribute("width", f.width), e.flyoutRect_.setAttribute("height", f.height), e.flyoutRect_.setAttribute("x", this.RTL ? g.x - f.width: g.x), e.flyoutRect_.setAttribute("y", g.y))
        }
        this.width_ = a;
        Blockly.fireUiEvent(window, "resize")
    }
...
Blockly.Toolbox.prototype.init = function() {
    ...
    this.HtmlDiv = goog.dom.createDom("div", "blocklyToolboxDiv");/*´´Ôì¸öDOM½á¹¹£¬classÎªblocklyToolboxDivµÄDIV*/
    this.HtmlDiv.setAttribute("dir", this.workspace_.RTL ? "RTL": "LTR");/*×ó¶ÔÆë ÓÒ¶ÔÆë*/
    document.body.appendChild(this.HtmlDiv);/*ÏòbodyÀïÃæµÄÄ©Î²Ìí¼Ó×Ó½Úµã*/
...
Blockly.Css.CONTENT = [".blocklySvg {", "  background-color: #F7F8FA;", "  outline: none;", "  overflow: hidden;", "}", ".blocklyWidgetDiv {", "  display: none;", "  position: absolute;", "  z-index: 999;", "}", ".blocklyTooltipDiv {", "  background-color: #ffffc7;", "  border: 1px solid #ddc;", "  box-shadow: 4px 4px 20px 1px rgba(0,0,0,.15);", "  color: #000;", "  display: none;", "  font-family: sans-serif;", "  font-size: 9pt;", "  opacity: 0.9;", "  padding: 2px;", "  position: absolute;", "  z-index: 1000;", "}", ".blocklyResizeSE {", "  cursor: se-resize;", "  fill: #aaa;", "}", ".blocklyResizeSW {", "  cursor: sw-resize;", "  fill: #aaa;", "}", ".blocklyResizeLine {", "  stroke: #888;", "  stroke-width: 1;", "}", ".blocklyHighlightedConnectionPath {", "  fill: none;", "  stroke: #fc3;", "  stroke-width: 4px;", "}", ".blocklyPathLight {", "  fill: none;", "  stroke-linecap: round;", "  stroke-width: 1;", "}", ".blocklySelected>.blocklyPath {", "  stroke: #fc3;", "  stroke-width: 3px;", "}", ".blocklySelected>.blocklyPathLight {", "  display: none;", "}", ".blocklyDragging>.blocklyPath,", ".blocklyDragging>.blocklyPathLight {", "  fill-opacity: .8;", "  stroke-opacity: .8;", "}", ".blocklyDragging>.blocklyPathDark {", "  display: none;", "}", ".blocklyDisabled>.blocklyPath {", "  fill-opacity: .5;", "  stroke-opacity: .5;", "}", ".blocklyDisabled>.blocklyPathLight,", ".blocklyDisabled>.blocklyPathDark {", "  display: none;", "}", ".blocklyText {", "  cursor: default;", "  fill: #fff;", "  font-family: sans-serif;", "  font-size: 11pt;", "}", ".blocklyNonEditableText>text {", "  pointer-events: none;", "}", ".blocklyNonEditableText>rect,", ".blocklyEditableText>rect {", "  fill: #fff;", "  fill-opacity: .6;", "}", ".blocklyNonEditableText>text,", ".blocklyEditableText>text {", "  fill: #000;", "}", ".blocklyEditableText:hover>rect {", "  stroke: #fff;", "  stroke-width: 2;", "}", ".blocklyBubbleText {", "  fill: #000;", "}", ".blocklySvg text {", "  user-select: none;", "  -moz-user-select: none;", "  -webkit-user-select: none;", "  cursor: inherit;", "}", ".blocklyHidden {", "  display: none;", "}", ".blocklyFieldDropdown:not(.blocklyHidden) {", "  display: block;", "}", ".blocklyIconGroup {", "  cursor: default;", "}", ".blocklyIconGroup:not(:hover),", ".blocklyIconGroupReadonly {", "  opacity: .6;", "}", ".blocklyMinimalBody {", "  margin: 0;", "  padding: 0;", "}", ".blocklyCommentTextarea {", "  background-color: #ffc;", "  border: 0;", "  margin: 0;", "  padding: 2px;", "  resize: none;", "}", ".blocklyHtmlInput {", "  border: none;", "  font-family: sans-serif;", "  font-size: 11pt;", "  outline: none;", "  width: 100%", "}", ".blocklyMainBackground {}", ".blocklyMutatorBackground {", "  fill: #fff;", "  stroke: #ddd;", "  stroke-width: 1;", "}", ".blocklyFlyoutBackground {", "  fill: #ddd;", "  fill-opacity: .8;", "}", ".blocklyScrollbarBackground {", "  opacity: 0;", "}", ".blocklyScrollbarKnob {", "  fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarKnob,", ".blocklyScrollbarKnob:hover {", "  fill: #bbb;", "}", ".blocklyFlyout .blocklyScrollbarKnob {", "  fill: #bbb;", "}", ".blocklyFlyout .blocklyScrollbarBackground:hover+.blocklyScrollbarKnob,", ".blocklyFlyout .blocklyScrollbarKnob:hover {", "  fill: #aaa;", "}", ".blocklyInvalidInput {", "  background: #faa;", "}", ".blocklyAngleCircle {", "  stroke: #444;", "  stroke-width: 1;", "  fill: #ddd;", "  fill-opacity: .8;", "}", ".blocklyAngleMarks {", "  stroke: #444;", "  stroke-width: 1;", "}", ".blocklyAngleGauge {", "  fill: #f88;", "  fill-opacity: .8;  ", "}", ".blocklyAngleLine {", "  stroke: #f00;", "  stroke-width: 2;", "  stroke-linecap: round;", "}", ".blocklyContextMenu {", "  border-radius: 4px;", "}", ".blocklyDropdownMenu {", "  padding: 0 !important;", "}", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {", "  background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px !important;", "}", ""+
".blocklyToolboxDiv {", " z-index:10;", "-webkit-overflow-scrolling:touch;", " background-color: #212429;", "  position: absolute;", "overflow-y:scroll;", "}", ".blocklyTreeRoot {", "", "}", ".blocklyTreeRoot:focus {", "  outline: none;", "}", ""+
".blocklyTreeRow {", "height:20px; ", " line-height:20px; ", "padding:3px 10px!important;", "  white-space: nowrap;", " cursor:pointer;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', "  padding-right: 0;", "  padding-left: 1em !important;", " color:#fff; ", "}", ""+
".blocklyTreeRow span:nth-child(4){", "background-image:url(<<<PATH>>>/sprites.png) ;", "background-repeat:no-repeat; ", " visibility:hidden;", " float:right; ", "margin-top:5px;", " background-position:-50px 0; ", " width:6px; ", "height:10px; ", "}", ""+
".blocklyTreeSelected span:nth-child(4){", "visibility:visible;","display:block!important;", " background-position:-58px 0;", "}", ""+
".blocklyTreeRow:hover {", " ", "}", ".blocklyTreeSeparator {", " height:0;", "  margin: 0;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedLtr {", "  background-position: -32px -17px;", "}", ""+
".blocklyTreeSelected>.blocklyTreeIconClosedRtl {", "  background-position: 0px -17px;", "}", "" +
".blocklyTreeLabel {", " height:20px;", " line-height:20px;", " float:left; ", "background-image: url(<<<PATH>>>/ico.png);", " background-repeat:no-repeat;", " color: #AEB3B8;", " font-weight:bold; ", " font-size: 14px;", "  padding: 0 15px 0 30px;", "  vertical-align: middle;", "}", "" +
"span1{", "background-position:0px 0px;", "}", "" +
"span2{", "background-position:0px -30px;", "}", "" +
"span3{", "background-position:0px -60px;", "}", "" +
"span4{", "background-position:0px -90px;", "}", "" +
"span5{", "background-position:0px -120px;", "}", "" +
"span6{", "background-position:0px -150px;", "}", "" +
"span7{", "background-position:0px -180px;", "}", "" +
"span8{", "background-position:0px -210px;", "}", "" +
"span9{", "background-position:0px -240px;", "}", "" +
"span10{", "background-position:0px -270px;", "}", "" +
"span11{", "background-position:0px -300px;", "}", "" +
".blocklyTreeSelected{", "padding:10px!important;", "background: #373D42;", " }", "" +
".blocklyTreeSelected .blocklyTreeLabel {", "  color: #fff;", "}" +
".blocklyTreeSelected .blocklyTreeLabel{", " background-image: url(<<<PATH>>>/ico2.png);", " background-repeat:no-repeat;", "}", "" +
".blocklyTreeSelected span1{", "background-position:0px 0px;", "}", "" +
".blocklyTreeSelected span2{", "background-position:0px -30px;", "}", "" +
".blocklyTreeSelected span3{", "background-position:0px -60px;", "}", "" +
".blocklyTreeSelected span4{", "background-position:0px -90px;", "}", "" +
".blocklyTreeSelected span5{", "background-position:0px -120px;", "}", "" +
".blocklyTreeSelected span6{", "background-position:0px -150px;", "}", "" +
".blocklyTreeSelected span7{", "ackground-position:0px -180px;", "}", "" +
".blocklyTreeSelected span8{", "background-position:0px -210px;", "}", "" +
".blocklyTreeSelected span9{", "background-position:0px -240px;", "}", "" +
".blocklyTreeSelected span10{", "background-position:0px -270px;", "}", "" +
".blocklyTreeSelected span11{", "background-position:0px -300px;", "}", "" +
".blocklyTreeRow1,.blocklyTreeRow2,.blocklyTreeRow3,.blocklyTreeRow4,.blocklyTreeRow5,.blocklyTreeRow6{", "background:#2A2E33;", "}", ""+
".blocklyWidgetDiv .goog-palette {", "  outline: none;", "  cursor: default;", "}", "" +
".blocklyWidgetDiv .goog-palette-table {", "  border: 1px solid #666;", "  border-collapse: collapse;", "}", "" +
".blocklyWidgetDiv .goog-palette-cell {", "  height: 13px;", "  width: 15px;", "  margin: 0;", "  border: 0;", "  text-align: center;", "  vertical-align: middle;", "  border-right: 1px solid #666;", "  font-size: 1px;", "}", "" +
...
Blockly.inject = function(a, b) {
    ...
    /*左侧导航边距，上半部分颜色*/  
    var oId1=document.getElementById(":1");
    oId1.style.backgroundColor="#2A2E33";
    oId1.style.paddingTop="10px";
    var oId2=document.getElementById(":2");
    oId2.style.backgroundColor="#2A2E33";
    var oId3=document.getElementById(":3");
    oId3.style.backgroundColor="#2A2E33";
    var oId4=document.getElementById(":4");
    oId4.style.backgroundColor="#2A2E33";
    var oId5=document.getElementById(":5");
    oId5.style.backgroundColor="#2A2E33";
    var oId6=document.getElementById(":6");
    oId6.style.backgroundColor="#2A2E33";
    oId6.style.paddingBottom="10px";
    oId6.style.borderBottom="1px solid #14161A";
    var oId7=document.getElementById(":7");
    oId7.style.paddingTop="10px";
    oId7.style.borderTop="1px solid #282C32";  
    var oIdb=document.getElementById(":b");
    oIdb.style.paddingBottom="10px";
    return d
};
...
Blockly.parseOptions_ = function(a) {
    ...
    if (b) var c = null,
        ...
        h = !1,
        k = !1;
    else c = Blockly.parseToolboxTree_(a.toolbox),
...
Blockly.init_ = function(a) {
    var b = a.options;
    Blockly.bindEvent_(a.options.svg, "contextmenu", null,
        function(a) {
    ...
    if (b.languageTree) if (a.toolbox_) a.toolbox_.init(a);
    else if (a.flyout_) {
        a.flyout_.init(a);
...
Blockly.bindEvent_.TOUCH_MAP = {}; goog.events.BrowserFeature.TOUCH_ENABLED && (Blockly.bindEvent_.TOUCH_MAP = {
    ...
    if (document.createEvent) c = document.createEvent("UIEvents"),
        c.initEvent(b, !0, !0),
        a.dispatchEvent(c);
    ...
    if (a = (a = a.getAttribute("transform")) && a.match(/translate\(\s*([-\d.]+)([ ,]\s*([-\d.]+)\s*\))?/)) b.x += parseFloat(a[1]),
...
}; Blockly.INPUT_VALUE = 1; Blockly.OUTPUT_VALUE = 2; Blockly.NEXT_STATEMENT = 3; Blockly.PREVIOUS_STATEMENT = 4; Blockly.DUMMY_INPUT = 5; Blockly.ALIGN_LEFT = -1; Blockly.ALIGN_CENTRE = 0; Blockly.ALIGN_RIGHT = 1; Blockly.OPPOSITE_TYPE = []; Blockly.OPPOSITE_TYPE[Blockly.INPUT_VALUE] = Blockly.OUTPUT_VALUE; Blockly.OPPOSITE_TYPE[Blockly.OUTPUT_VALUE] = Blockly.INPUT_VALUE; Blockly.OPPOSITE_TYPE[Blockly.NEXT_STATEMENT] = Blockly.PREVIOUS_STATEMENT; Blockly.OPPOSITE_TYPE[Blockly.PREVIOUS_STATEMENT] = Blockly.NEXT_STATEMENT; 
Blockly.selected = null; 
Blockly.highlightedConnection_ = null; 
Blockly.localConnection_ = null; Blockly.DRAG_RADIUS = 5; Blockly.SNAP_RADIUS = 20; Blockly.BUMP_DELAY = 250; Blockly.COLLAPSE_CHARS = 30; Blockly.LONGPRESS = 750; 
Blockly.mainWorkspace = null; Blockly.clipboardXml_ = null; 
...
Blockly.svgSize = function(a) {
    ...
    if (b.isScrolling) {
        ...
        Math.sqrt(Math.pow(c, 2) + Math.pow(d, 2)) > Blockly.DRAG_RADIUS && Blockly.longStop_();
        a.stopPropagation()
    }
}; Blockly.onKeyDown_ = function(a) {
    if (!Blockly.isTargetInput_(a)) if (27 == a.keyCode) Blockly.hideChaff();
        ...
        a.preventDefault()
    } else if (a.altKey || a.ctrlKey || a.metaKey) Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (Blockly.hideChaff(), 67 == a.keyCode ? Blockly.copy_(Blockly.selected) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected), Blockly.selected.dispose(!0, !0))),
    86 == a.keyCode && Blockly.clipboardXml_ && Blockly.clipboardSource_.paste(Blockly.clipboardXml_)
    ...
    if (this.scrollbar) var f = this.RTL ? 0 : Blockly.Scrollbar.scrollbarThickness,
        ...
        f = d.y,
        c = f + d.height;
    d = 0; ! this.RTL && this.toolbox_ && (d = this.toolbox_.width);
    return {
        viewHeight: a.height,
        viewWidth: a.width,
        contentHeight: c - f,
...
}; goog.global.Blockly || (goog.global.Blockly = {}); goog.global.Blockly.getMainWorkspace = Blockly.getMainWorkspace; goog.global.Blockly.addChangeListener = Blockly.addChangeListener; goog.global.Blockly.removeChangeListener = Blockly.removeChangeListener;
