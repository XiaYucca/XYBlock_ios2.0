...
//        }
//    });
    html_bridge.callHandler('testObjcCallback', {'data': 'xmlTemp','fileCMD':'saveFile'}, function(response) {
                            log('JS got response', response)
                            /*  var btn_test = document.getElementById("test_updataBtn");
                             
                             var testContentXml = document.getElementById("content_xml");
                             
                             xmlTemp = response;
                             
                             
                             testContentXml.value = response;
                             btn_test.innerHTML = "保存数据";
                             data_change();
...
//                                 }
    ...
    _bridge.callHandler('testObjcCallback', {'data': 'xmlTemp','fileCMD':'saveFile'}, function(response) {
                       log('JS got response', response)
                       /*  var btn_test = document.getElementById("test_updataBtn");
